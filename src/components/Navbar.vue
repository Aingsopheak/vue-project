  ...
  <nav class="navbar">
    ...
    <ul class="navbar__desktop-menu">
      <li class="navbar__desktop-menu__link">
        ...
        <router-link to="/category/headphones">APPLE</router-link>
        <router-link to="/category/speakers">SAMSUNG</router-link>
        <router-link to="/category/earphones">OPPO</router-link>
      </li>
    </ul>
    <button
